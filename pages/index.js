...
import { checkWinner, checkMainWinner } from '../helpers/checkMultipleIF'
...
export default function Home() {
  ...
  return (
    <div className='p-1 h-screen'>
      <div id='gameScreen' className='min-h-full grid grid-cols-3 grid-rows-3 gap-1'>
        {simpleArray.map((i) => (
          <div
            key={i}
            id={i}
            ...
            {simpleArray.map((j) => (
              <div
                ...
                onClick={(e) => {
                  ...
                  var parent = e.target.parentElement.innerHTML
